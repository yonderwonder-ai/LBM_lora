...
class TrainingConfig(BaseConfig):
    ...
    Args:
        ...
        optimizers_update_steps (List[int]):
            The number of consecutive steps to update the optimizer before switching to the next optimizer. Default is [1]
    ...
    optimizers_update_steps: Optional[List[int]] = None
    ...
    def __post_init__(self):
        ...
        if self.optimizers_update_steps is None:
            self.optimizers_update_steps = [1 for _ in self.optimizers_name]
